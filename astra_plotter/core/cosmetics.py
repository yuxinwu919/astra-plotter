"""
Cosmetics Module - Color Maps, Styles, and Plot Formatting
==========================================================

Provides publication-quality color maps (including the SLAC-DESY beam
color map), plot styling functions, and formatting utilities for
consistent visualization across the package.

Key Features:
- SLAC-DESY beam color map (from C. Behrens, DESY / T. Maxwell, SLAC)
- Publication-ready matplotlib rcParams
- Tick label formatting for scientific plots
"""
...
# ============================================================================
# SLAC-DESY Beam Color Map
# ============================================================================
# Original MATLAB colormap by C. Behrens (DESY), adapted by T. Maxwell (SLAC),
# ported to Python.
...
# Create the colormap
SLAC_DESY_CMAP = LinearSegmentedColormap.from_list(
    'SLAC_DESY', _SLAC_DESY_CM_DATA
)
...
def set_publication_style(font_size=14, use_tex=True):
    """
    ...
    use_tex : bool
        Whether to use LaTeX for text rendering (requires dvipng/LaTeX).
    """
    import matplotlib.pyplot as plt
    ...
    params = {
        ...
        # Grid — faint lines at major tick positions, behind data
        'axes.grid': True,
        'axes.axisbelow': True,
        'grid.alpha': 0.25,
        'grid.linestyle': '-',
...
def PrettyPlot(nbins=5):
    ...
    ----------
    nbins : int
        Number of major ticks per axis.
    """
